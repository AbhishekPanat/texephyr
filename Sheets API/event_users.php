...
$range = "Event User Data!A2";
$values = [];

$sql = "SELECT r.receipt_id, r.order_id ,e.title, u.fest_id, u.name, u.college_name, u.phone_no, u.email
FROM receipts_event_participant rp INNER JOIN users u
ON u.fest_id = rp.user_id
INNER JOIN receipts r
ON rp.receipt_id = r.receipt_id AND r.receipt_status = '1' AND r.type = '0'
INNER JOIN event e
ON rp.event_id = e.event_ID ORDER BY r.receipt_id ASC";
