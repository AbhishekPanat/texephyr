                    ...
                    <div class="col-md-8 offset-md-2 mt-3 wow fadeInUp">
                        ...
                        if(mysqli_num_rows($res_datathon) > 0)
                        {
                         ?>
                            ...
                            <br>
                            <p style="color: var(--primary-color-1);">You have a total of 
                            <?php 
                              $sql =  "SELECT count(*) as count FROM datathon_leaderboards WHERE fest_id = '".$_SESSION['USER_ID']."'";
                              $res = mysqli_query($con, $sql);
                              $res1 = mysqli_fetch_assoc($res)['count'];
                              $count = 5 - (int)$res1;
                              echo strval($count);
                            ?> attempts.</p>
                            <div class="outer_table" style="margin-top: 2rem;">
                                <table class="table table-border" style="color: var(--primary-color-1);">
                                    ...
                                    <tbody> 
                                        <?php
                                            $counter = 1;
                                            $sql = "SELECT * FROM datathon_leaderboards WHERE fest_id='".$_SESSION['USER_ID']."'";
                                            $res = mysqli_query($con,$sql);
