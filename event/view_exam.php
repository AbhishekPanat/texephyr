...
<div class="row" id="instruction">
	...
	<main class="bg-[#eee] py-[1rem] font-sans">
        <div class="mx-36 drop-shadow-lg  p-4 bg-white rounded-lg resp">
          <div class="mx-10 my-5">
            <h1 class="text-[1.75rem] font-semibold resp1">Instructions</h1>
          </div>
          ...
          <div class="main w-4/5 mx-auto py-8 text-neutral-500 resp3">
            <p>Please read the instruction carefully before you proceed</p>
            <br>
            <ul class="list-disc ml-10 mt-3 text-sm resp2">
               <li>
                Contestants will have to answer a set of questions.Questions
                wil be of multiple choice and the contestant has to choose the appropriate
                one.Questions will be based on technical know-how.
              </li>
              <li>
                The duration of the test will be of 30 mins to answer 30 Questions.
              </li>
              <li>
                Participants have to finish the test on time.
              </li>
              <li>
               Make sure you do not change the tab while giving the exam as the platform 
               will detect it automatically and deduct your points.
              </li>
               <li>
                Qualified students will be selected for next coding round.
              </li>
              <li>
                Do Not switch tabs while taking the test. Switching Tabs will Block / End 
                the test automatically.
              </li>
              <li>
                The test will only run in full screen mode. Do not switch back to tab mode. 
                Test will end automatically.You may need to use blank sheets for rough work. 
                Please arrange for blank sheets before starting.
              </li>
              <li>
                Clicking on Back or Next will save the answer. Questions can be reattempted
                till the time test is running.
              </li>
              <li>
...
<div class="row mx-36 resp7" id="demo-element" style="display:none;padding-top: 4rem;background: #eee;">
	<div class="col-xs-4 col-md-8 resp4">
		<div class="card resp6">
			<div class="card-header">Online Exam</div>
			<div class="card-body" style="height: 35rem;overflow: scroll;">
				<div id="single_question_area" class="resp5"></div>
			</div>
		</div>
		<br />
	...
	<div class="col-md-4">
		<br />
		<div>
			<div class="resp8" id="exam_timer" data-timer="<?php echo $duration_final; ?>" style="max-width:400px; width: 100%; height: 200px;"></div>
		</div>
		<br />
		<div id="question_navigation_area" style="overflow-y: scroll;
    height: 19rem;"></div>		
	</div>
</div>
