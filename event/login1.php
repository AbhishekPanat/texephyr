  ...
  <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6" style="margin-top:100px;">
            ...
            <img style="width:300px" src="logo/logo-2022.png">
            ...
            <div class="card">
              <div class="card-header" style="font-weight:bold;">User Login</div>
              <div class="card-body">
                <form method="post" id="user_login_form">
                    <p style="opacity:.8;">*Note:Use your Texephyr email-id and password</p>
