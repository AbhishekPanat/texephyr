<?php
$con = mysqli_connect("localhost","u570306383_texephyr22","MitTex@22","u570306383_texephyr");
class Examination
{
	var $host;
	var $username;
	...
	{
		$this->host = 'localhost';
		$this->username = 'u570306383_texephyr22';
		$this->password = 'MitTex@22';
		$this->database = 'u570306383_texephyr';
		$this->home_page = 'http://event.texephyr.in/';
	...
	function send_email($receiver_email, $subject, $body)
	{
		...
		$mail->Username = 'abhipanat676@gmail.com';

		$mail->Password = '@bhi5PANAT';

		$mail->SMTPSecure = 'SSL';

		$mail->From = 'abhipanat676@gmail.com';

		$mail->FromName = 'abhipanat676@gmail.com';
	...
	function Get_user_exam_answer($exam_id, $user_id,$question_id)
	{
		$this->query = "
		SELECT * FROM user_exam_question_answer 
		WHERE exam_id = '$exam_id' 
		AND user_id = '$user_id' AND question_id = '$question_id'
		";
		$result = $this->query_result();
		foreach($result as $row)
		{
